...
//    [self addNotify];
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(10, 80, 300, 44)];
    ...
    SCLabel *label = [[SCLabel alloc] initWithFrame:CGRectMake(10, 134, 300, 44)];
    ...
    label.textChangeCB = ^(CGFloat newWidth, CGFloat newHeight, NSString *newText) {
        ...
        label2.frame = CGRectMake(10, label.bottom + 10, 300, 44);
    };
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        label.enableLongPressGesture = YES;
    });
    
    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(10, label.bottom + 10, 300, 44)];
